...
export default function AdminSidebar({ isOpen, onClose }) {
    ...
    const navItems = [
        ...
        { name: 'Revenue Tracker', icon: BadgeDollarSign, path: '/admin/revenue' },
        ...
        <>
            ...
            `}>
                    ...
                    <div className="flex items-center justify-between w-full px-2">
                        <Link to="/admin/dashboard" className="flex items-center gap-3 group">
                            ...
                            <div className="flex flex-col text-white font-black uppercase tracking-tight leading-none md:hidden lg:flex">
                                ...
                                <span className="text-slate-500 text-[9px] tracking-[0.2em] mt-1 font-black">Admin Portal</span>
                            </div>
                        </Link>
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Matched font style and size to ClientSidebar */}
                ...
                <div className="sidebar-bottom space-y-6 w-full flex flex-col items-center lg:items-stretch">
                    {/* Settings Link with matched ClientSidebar styles */}
                    <Link
                        to="/admin/settings"
                        className={`
