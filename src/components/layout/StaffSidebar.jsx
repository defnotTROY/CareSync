...
export default function StaffSidebar({ isOpen, onClose }) {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (profile) {
                        ...
                        setStaffName(fullName || 'Staff Member');
                    }
                }
            } catch (err) {
                console.error(err);
    ...
    const isSettingsActive = location.pathname === '/staff/settings';
                    ...
                    <div className="flex items-center justify-between w-full px-2">
                        <Link to="/staff/dashboard" className="flex items-center gap-3 group">
                            ...
                            <div className="flex flex-col text-white font-black uppercase tracking-tight leading-none md:hidden lg:flex">
                                ...
                                <span className="text-slate-500 text-[9px] tracking-[0.2em] mt-1 font-black">Staff Terminal</span>
                            </div>
                        </Link>
