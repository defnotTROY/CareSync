        ...
        <div className="flex min-h-screen bg-white text-black">
            ...
            <div className="hidden lg:flex w-1/2 bg-black p-16 flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-2">
                    ...
                    <span className="text-white font-bold text-xl tracking-tight">CareSync</span>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="w-full max-w-md space-y-10">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-white border-2 border-slate-100 rounded-xl focus:border-black focus:outline-none transition-all placeholder:text-slate-300"
                                />
                                <Eye className="absolute right-4 top-3.5 text-slate-300 cursor-pointer hover:text-black" size={18} />
                            </div>
                        </div>

                        <button className="w-full py-4 bg-black text-white rounded-xl font-bold hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
                            LOG IN
                        </button>
                    </form>
                    ...
                    <p className="text-center text-sm text-slate-500 font-medium">
                        Don't have an account? <a href="#" className="text-black font-bold hover:underline">Register here</a>
                    </p>
